...
| `PlayPlayMini.VN`                 | Visual Novel game engine. Preview release, but contains many features. Has been used in games published to Steam.                                         | [NuGet](https://www.nuget.org/packages/BenMakesGames.PlayPlayMini.VN)<br />[Documentation](BenMakesGames.PlayPlayMini.VN/README.md) |
